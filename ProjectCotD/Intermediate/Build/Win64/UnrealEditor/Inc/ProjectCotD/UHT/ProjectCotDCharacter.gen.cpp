...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AProjectCotDCharacter_Statics::NewProp_TopDownCameraComponent = { "TopDownCameraComponent", nullptr, (EPropertyFlags)0x00400000000a001d, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AProjectCotDCharacter, TopDownCameraComponent), Z_Construct_UClass_UCameraComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_TopDownCameraComponent_MetaData), NewProp_TopDownCameraComponent_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AProjectCotDCharacter_Statics::NewProp_CameraBoom = { "CameraBoom", nullptr, (EPropertyFlags)0x00400000000a001d, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AProjectCotDCharacter, CameraBoom), Z_Construct_UClass_USpringArmComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CameraBoom_MetaData), NewProp_CameraBoom_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AProjectCotDCharacter_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AProjectCotDCharacter_Statics::NewProp_TopDownCameraComponent,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AProjectCotDCharacter_Statics::NewProp_CameraBoom,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AProjectCotDCharacter_Statics::PropPointers) < 2048);
...
const UECodeGen_Private::FClassParams Z_Construct_UClass_AProjectCotDCharacter_Statics::ClassParams = {
	...
	DependentSingletons,
	nullptr,
	Z_Construct_UClass_AProjectCotDCharacter_Statics::PropPointers,
	nullptr,
	UE_ARRAY_COUNT(DependentSingletons),
	0,
	UE_ARRAY_COUNT(Z_Construct_UClass_AProjectCotDCharacter_Statics::PropPointers),
	0,
	0x008000A4u,
...
struct Z_CompiledInDeferFile_FID_Users_totof_Documents_Work_vertical_Project_CotD_ProjectCotD_Source_ProjectCotD_ProjectCotDCharacter_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AProjectCotDCharacter, AProjectCotDCharacter::StaticClass, TEXT("AProjectCotDCharacter"), &Z_Registration_Info_UClass_AProjectCotDCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AProjectCotDCharacter), 1227063592U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_totof_Documents_Work_vertical_Project_CotD_ProjectCotD_Source_ProjectCotD_ProjectCotDCharacter_h_1678586160(TEXT("/Script/ProjectCotD"),
